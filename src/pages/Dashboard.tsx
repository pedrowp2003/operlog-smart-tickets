...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Desktop side panels */}
      <aside className="hidden lg:flex fixed left-4 top-[4.5rem] bottom-4 w-[360px] border border-border rounded-lg bg-card flex-col p-4 gap-2 z-40 shadow-sm">
      ...
      <aside className="hidden lg:flex fixed right-4 top-[4.5rem] bottom-4 w-[360px] border border-border rounded-lg bg-card flex-col p-4 gap-2 z-40 shadow-sm">
        <div className="flex items-center gap-2 text-sm font-semibold">
      ...
      <main className="max-w-4xl mx-auto px-4 py-4 lg:px-8 lg:ml-[380px] lg:mr-[380px] lg:max-w-none">
